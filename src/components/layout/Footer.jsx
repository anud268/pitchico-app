    ...
    <footer className="bg-dark text-white pt-20 md:pt-32 pb-8 px-6 border-t border-gray-900">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 border-b border-gray-800 pb-16 mb-8">
        ...
        <div className="lg:col-span-2 md:pr-10">
          <Link href="/" className="text-3xl font-logo font-bold tracking-wide inline-block mb-6">
        ...
        <div>
          ...
          <div className="flex flex-col gap-5 text-gray-400 text-sm">
            ...
            <a href="mailto:info.pitchico@gmail.com" className="flex items-center gap-3 hover:text-gold transition-colors inline-flex w-fit group">
        ...
        <div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex items-center gap-4 mt-6">
              ...
              <a href="mailto:info.pitchico@gmail.com" className="w-10 h-10 rounded-full bg-gray-900 border border-gray-800 flex items-center justify-center text-gray-400 hover:text-white hover:border-white hover:-translate-y-1 transition-all duration-300 shadow-sm">
